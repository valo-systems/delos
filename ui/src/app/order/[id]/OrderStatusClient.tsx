            ...
            {error ? (
              ...
              <>
                ...
                <div className="text-center mb-10">
                  <p className="text-xs tracking-[0.3em] text-gold/60 uppercase mb-2">
                    Order
                  </p>
                  <h1
                  ...
                  <span
                    className={`text-xl font-semibold ${
                      STATUS_COLOR[order.status as OrderStatus] ?? "text-cream"
                    }`}
                  >
                ...
                <div className="text-center space-y-3">
                  ...
                  <a
                    href={`https://wa.me/${siteConfig.contact.whatsapp.replace(/\D/g, "")}?text=${encodeURIComponent(
                      `Hi, I have a question about order ${order.id}`
                    )}`}
                    target="_blank"
