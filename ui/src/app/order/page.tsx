                    ...
                    <>
                      ...
                      {belowMinimum && (
                        <p className="mt-3 text-xs text-wine">
                          ...
                          {formatPrice((minOrder - totals.subtotal) * 100)} more to
                          checkout.
                        </p>
                      )}
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="bg-black/50 border border-gold/10 p-4 text-xs text-cream/60 leading-relaxed">
                  ...
                  Our team will confirm your order via WhatsApp. Pay on collection or delivery.
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button
                    ...
                    disabled={submitting}
                  >
                    {submitting ? "Placing order…" : `Place order · ${formatPrice(totals.total * 100)}`}
                  </Button>
                  <Button
